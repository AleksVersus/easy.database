...
Таблица данных разбивается на колокни для удобства размещения информации. Как правило, колонка необходима для хранения неких однотипных данных, реализующих какое либо свойство для хранимой записи. Например в таблице предметов может быть создана отдельная колонка для хранения названия, отдельная — для хранения веса, для хранения количества, и так далее.
